$(document).ready(function () {
    ...
    var myCalendar = createCalendar({
        ...
        data: {
            // Event title
            title: "Dave and Meredith's Wedding",

            // Event start date
            start: new Date('Jul 13, 2019 16:00'),
    ...
    $('#rsvp-form').on('submit', function (e) {
        ...
        if (MD5($('#invite_code').val()) !== '63a63d710875a3a5b96a754997ba3001') {
            $('#alert-wrapper').html(alert_markup('danger', '<strong>Sorry!</strong> Your invite code is incorrect.'));
        } else {
            $.post('https://script.google.com/macros/s/AKfycbxbNUD0awhpo4dQ4_vIaSA6ZvEzdZ2YYDF7pMGaMA/exec', data)
                .done(function (data) {
                    console.log(data);
...
// Google map
function initMap() {
    var itc_kol = {lat: 43.5264545, lng: -71.6759613};
...
function initBBSRMap() {
    var la_fiesta = {lat: 43.5264545, lng: -71.6759613};
    var map = new google.maps.Map(document.getElementById('map-canvas'), {
        zoom: 15,
        center: la_fiesta,
        scrollwheel: false
